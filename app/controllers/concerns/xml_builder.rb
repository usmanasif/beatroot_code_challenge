module XMLBuilder
  ...
  def prepare_xml_data(release_id)
    release = BeatrootApi.fetch_release(params[:id])
    tracks = []
  ...
  private
    ...
    def resource_list_xml(tracks)
      ...
      resource_list.to_xml(save_with: Nokogiri::XML::Node::SaveOptions::NO_EMPTY_TAGS | Nokogiri::XML::Node::SaveOptions::FORMAT)
    end
    ...
    def release_xml(release)
      ...
      release.doc.children.to_xml(save_with: Nokogiri::XML::Node::SaveOptions::NO_EMPTY_TAGS | Nokogiri::XML::Node::SaveOptions::FORMAT)
    end
